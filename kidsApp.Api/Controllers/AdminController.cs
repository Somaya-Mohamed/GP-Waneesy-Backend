...
//        [HttpGet("users/{id}")]
//        public async Task<IActionResult> GetUserById(string id)   // ← تغيير مهم: string
//        {
...
//        [HttpPut("users/{id}")]
//        public async Task<IActionResult> UpdateUser(string id, [FromBody] AdminUpdateUserDTO dto)  // ← string
//        {
//            if (!ModelState.IsValid)
//                return BadRequest(new { Success = false, Message = "Invalid data", Errors = ModelState });
...
//        [HttpDelete("users/{id}")]
//        public async Task<IActionResult> DeleteUser(string id)   // ← string
//        {
